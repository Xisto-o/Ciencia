...
grounds = [
    ...
    pygame.Rect(15, 615 + ground_y, 175, 25),
    pygame.Rect(180, 645 + ground_y, 120, 25),
    pygame.Rect(270, 585 + ground_y, 105, 25),
    pygame.Rect(318, 535 + ground_y, 150, 25),
    pygame.Rect(478, 565 + ground_y, 115, 25),

    pygame.Rect(530, 435 + ground_y, 100, 25),
    pygame.Rect(605, 480 + ground_y, 75, 25),
    pygame.Rect(640, 438 + ground_y, 115, 25),

    # ========================================================
    # CENTRO-ESQUERDA
    # ========================================================

    pygame.Rect(735, 380 + ground_y, 90, 25),
    pygame.Rect(805, 535 + ground_y, 90, 25),

    pygame.Rect(880, 210 + ground_y, 85, 25),
    pygame.Rect(928, 255 + ground_y, 150, 25),

    # ========================================================
    # CENTRO
    # ========================================================

    pygame.Rect(1125, 165 + ground_y, 115, 25),
    pygame.Rect(1205, 320 + ground_y, 50, 25),
    pygame.Rect(1265, 150 + ground_y, 160, 25),
    pygame.Rect(1320, 340 + ground_y, 125, 25),

    pygame.Rect(1110, 475 + ground_y, 65, 25),
    pygame.Rect(1395, 545 + ground_y, 80, 25),
    pygame.Rect(1415, 475 + ground_y, 75, 25),

    # ========================================================
    # DIREITA
    # ========================================================

    pygame.Rect(1465, 255 + ground_y, 135, 25),
    pygame.Rect(1575, 120 + ground_y, 200, 25),

    pygame.Rect(1630, 415 + ground_y, 145, 25),
    pygame.Rect(1670, 545 + ground_y, 130, 25),

    pygame.Rect(1420, 615 + ground_y, 105, 25),
    pygame.Rect(1530, 625 + ground_y, 110, 25),
    pygame.Rect(1640, 575 + ground_y, 150, 25),

    pygame.Rect(1760, 545 + ground_y, 165, 25),
    pygame.Rect(1825, 570 + ground_y, 155, 25),

    # ========================================================
    # PARTE INFERIOR
    # ========================================================

    pygame.Rect(305, 705 + ground_y, 70, 25),
    pygame.Rect(680, 650 + ground_y, 110, 25),
    pygame.Rect(820, 660 + ground_y, 100, 25),

    pygame.Rect(1045, 640 + ground_y, 175, 25),
    pygame.Rect(1200, 700 + ground_y, 185, 25),

    pygame.Rect(1300, 675 + ground_y, 100, 25),

    pygame.Rect(1625, 700 + ground_y, 310, 25),
    pygame.Rect(1880, 605 + ground_y, 140, 25),
]
# ============================================================
# CÂMERA
# ============================================================
...
while running:
    ...
    # Guarda onde estava o jogador
    # antes de aplicar a gravidade.
    ...
    for ground in grounds:
        ...
        #
        # 1. caindo
        # 2. horizontalmente sobre a plataforma
        # 3. cruzando o topo dela neste frame

        if velocity_y >= 0:

            horizontal_overlap = (
                player.right > ground.left
                and player.left < ground.right
            )

            crossed_top = (
                previous_bottom <= ground.top
                and player.bottom >= ground.top
            )
            ...
            if (
                ...
                # Se estava no ar e acabou de pousar,
                # começa o timer da aterrissagem.
