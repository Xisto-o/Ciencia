...
grounds_fase4 = [
    ...
    # Ilha pequena superior esquerda
    ...
    # Plataforma do laboratório inicial
    ...
    # Plataforma grande inferior esquerda
    ...
    # Plataforma ao lado da estrutura
    ...
    # Plataforma grande com cachoeira
    ...
    # Plataforma do laboratório final
...
# ============================================================
# PORTA FINAL DA FASE 4
# ============================================================

doors_fase4 = [

    # Porta do laboratório no extremo direito.
...
def load_phase(new_phase):
    ...
    # ========================================================
        ...
        ground_image = pygame.image.load(
            "ciencia-main/game/assets/chao4.png"
        ).convert_alpha()


        background = pygame.image.load(
            "ciencia-main/game/assets/background4.png"
        ).convert()


        grounds = grounds_fase4

        hazards = hazards_fase4
...
while running:
    ...
    if not transitioning:
        ...
        for ground in grounds:
            ...
            # Só colide quando estiver caindo.
